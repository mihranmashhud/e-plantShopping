    ...
    <div>
        ...
        <div style={styleObjUl}>
          ...
          <div>
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <div class="cart_quantity_count">{cart.reduce((acc, item) => acc + item.quantity, 0)}</div>
              <h1 className="cart">
                <svg
      ...
      {!showCart ? (
        <div className="product-grid">
          {plantsArray.map(({ category, plants }, categoryIndex) => (
            <div key={categoryIndex}>
              <h1>{category}</h1>
              <div class="product-list">
                {plants.map((plant, plantIndex) => (
                  <div class="product-card" key={plantIndex}>
                    <h3 class="product-title">{plant.name}</h3>
                    <img class="product-image" src={plant.image} />
